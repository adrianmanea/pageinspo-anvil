    ...
    <div className="min-h-screen w-full bg-[#FFFFFF] dark:bg-[#0E0E0E] font-sans text-[13px] text-[#202020] dark:text-[#EEEEEE] antialiased selection:bg-[#F3F4F6] dark:selection:bg-[#333333]">
      ...
      <div className="mx-auto grid min-h-screen w-full lg:grid-cols-2">
        ...
        <div className="flex w-full flex-col justify-center px-[20px] py-[40px] md:items-center">
          <div className="flex w-full max-w-[293px] flex-col gap-[32px] md:mx-auto">
            {/* Header: Logo & Title */}
            ...
            {/* Auth Buttons */}
            <div className="flex w-[293px] flex-col gap-[16px]">
              <form className="flex flex-col gap-[20px]">
                <div className="flex flex-col">
                  <div className="mt-[4px] flex min-h-[28px] h-[41px] items-center overflow-hidden rounded-[4px] border-[0.666667px] border-[#BBBBBB] dark:border-[#606060] bg-[#FFFFFF] dark:bg-[#222222] shadow-[0px_1px_1px_0px_rgba(0,0,0,0.06)] dark:shadow-[0px_1px_2px_0px_rgba(0,0,0,0.24)] transition-colors focus-within:border-[#202020] dark:focus-within:border-[#EEEEEE]">
                    <input
                      type="email"
                      placeholder="name@work-email.com"
                      className="h-[40px] w-full bg-transparent px-[10px] py-[4px] text-[13px] font-[400] leading-[16px] text-[#202020] dark:text-[#EEEEEE] outline-none placeholder:text-[#BBBBBB] dark:placeholder:text-[#606060]"
                    />
                  </div>
                </div>
                <button
                  type="submit"
                  className="flex h-[40px] w-[293px] items-center justify-center rounded-[9999px] border-[0.666667px] border-[#BBBBBB] dark:border-[#606060] bg-[#FFFFFF] dark:bg-[#222222] px-[10px] py-[6px] text-[15px] font-[500] leading-[19px] text-[#202020] dark:text-[#EEEEEE] shadow-[0px_1px_1px_0px_rgba(0,0,0,0.06)] dark:shadow-[0px_1px_2px_0px_rgba(0,0,0,0.24)] transition-colors hover:bg-[#F5F5F5] dark:hover:bg-[#2A2A2A]"
                >
                  Continue with email
                </button>
              </form>
              ...
              <button
                type="button"
                className="flex h-[40px] w-[293px] items-center justify-center rounded-[9999px] border-[0.666667px] border-transparent bg-transparent px-[10px] py-[6px] text-[15px] font-[500] leading-[19px] text-[#626262] dark:text-[#B4B4B4] transition-colors hover:bg-[rgba(0,0,0,0.055)] dark:hover:bg-[rgba(255,255,255,0.063)]"
              >
                Back to login
              </button>
