        ...
        <div className="flex w-full flex-col justify-center px-[20px] py-[40px] md:items-center">
          <div className="flex w-full max-w-[293px] flex-col gap-[32px] md:mx-auto">
            ...
            <div className="flex w-[293px] flex-col gap-[16px]">
              ...
              <button
                type="button"
                className="flex h-[40px] w-[293px] items-center justify-center rounded-[9999px] border-[0.666667px] border-transparent bg-transparent px-[10px] py-[6px] text-[15px] font-[500] leading-[19px] text-[#626262] dark:text-[#B4B4B4] transition-colors hover:bg-[#F9FAFB] dark:hover:bg-[#333333]"
              >
                Back to login
              </button>
