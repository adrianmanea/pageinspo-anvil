        ...
        <header className="flex h-[49px] min-h-[49px] items-center justify-between border-b border-[#EEEFF1] dark:border-[#27282B] pl-[12px] pr-[12px]">
          <div className="flex items-center gap-[4px]">
            ...
            <div className="flex items-center gap-[6px] rounded-[4px] border border-[#E5E7EB] dark:border-[#27282B] bg-white dark:bg-[#1a1d21] px-[4px] py-[2px] shadow-sm">
              <Bell className="h-[14px] w-[14px] text-[#242529] dark:text-[#EEEFF1]" />
            ...
            <div className="flex flex-col justify-start items-stretch w-full gap-[28px]">
              ...
              <div className="flex flex-col gap-[28px] w-full max-w-[768px]">
                ...
                <section className="flex flex-col gap-[16px]">
                  ...
                  <div className="flex w-full h-[56px] items-center justify-between px-[12px] py-[8px] bg-[#FBFBFB] dark:bg-[#1A1D21] rounded-[12px] shadow-[inset_0_0_0_1px_#EEEFF1] dark:shadow-[inset_0_0_0_1px_#27282B]">
                ...
                <section className="flex flex-col gap-[16px]">
                  ...
                  {/* Table Container */}
                  <div className="flex flex-col w-full text-[14px] font-[500] leading-[20px] tracking-[-0.14px] text-[#242529] dark:text-[#EEEFF1]">
                    {/* Header Row */}
                    <div className="sticky top-0 z-10 flex flex-col gap-[16px] pt-[16px] -mt-[16px]">
                      <div className="grid grid-cols-[571.729px_71.4688px_71.4583px] w-full h-[40.6667px] px-[14px] py-[12px] gap-[12px] bg-[#FBFBFB] dark:bg-[#1A1D21] border-[0.666667px] border-solid border-[#EEEFF1] dark:border-[#27282B] border-b-0 rounded-t-[12px] shadow-[inset_0_-1px_0_0_#EEEFF1] dark:shadow-[inset_0_-1px_0_0_#27282B]">
                        {/* Col 1 */}
                    ...
                    <div className="flex flex-col w-full bg-[#FFFFFF] dark:bg-transparent border-r-[0.666667px] border-b-[0.666667px] border-l-[0.666667px] border-solid border-[#EEEFF1] dark:border-[#27282B] rounded-b-[12px]">
                      {/* Row 1: Mentions */}
                      <div className="grid grid-cols-[571.729px_71.4688px_71.4583px] w-full h-[52px] px-[14px] items-center gap-[12px]">
                        {/* Text */}
                        <div className="flex flex-col justify-center items-start h-full py-[8px]">
                      ...
                      <div className="grid grid-cols-[571.729px_71.4688px_71.4583px] w-full h-[52px] px-[14px] items-center gap-[12px] rounded-b-[12px]">
                        <div className="flex flex-col justify-center items-start h-full py-[8px]">
                          <span className="block text-[14px] font-[500] leading-[20px] tracking-[-0.14px] text-[#242529] dark:text-[#EEEFF1]">
