            ...
            <div className="flex flex-col w-full">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-[12px] bg-[#FFFFFF] dark:bg-[#15181C] py-[16px] z-10 sticky top-0">
                ...
                <button
                  ...
                  className="flex items-center justify-center h-[34px] px-[10px] bg-[#266DF0] rounded-[10px] gap-[6px] hover:bg-[#1D5AD6] transition-colors"
                >
              ...
              <div className="w-full overflow-x-auto overflow-y-hidden mb-[12px]">
                <div className="min-w-[500px] flex flex-col bg-[#FFFFFF] dark:bg-[#15181C] border border-[#EEEFF1] dark:border-[#27282B] rounded-[12px]">
                  {/* Table Header */}
          ...
          >
            ...
            <div className="flex items-center justify-between px-[8px] p-[8px] h-[44px] min-h-[44px] shrink-0 shadow-[inset_0_-1px_0_0_rgba(0,0,0,0.07)] dark:shadow-[inset_0_-1px_0_0_rgba(255,255,255,0.07)]">
              <div className="flex items-center gap-[6px] px-[4px]">
                <UserPlus className="w-[14px] h-[14px] text-[#242529] dark:text-[#EEEFF1]" />
                <span className="text-[14px] font-[500] text-[#242529] dark:text-[#EEEFF1] tracking-[-0.14px]">
                  Invite team members
                </span>
              </div>
            ...
            {/* Body */}
            <div className="flex flex-col flex-1 px-[16px] py-[16px] pb-[24px] gap-[12px]">
              {/* Row 1 */}
              <div className="flex flex-col gap-[4px]">
                <div className="flex items-center h-[16px] px-[4px]">
                  <span className="text-[12px] font-[500] text-[rgba(0,0,0,0.55)] dark:text-[rgba(255,255,255,0.55)] tracking-[-0.12px]">
                    Send Invite to ...
                  </span>
                </div>
                <div className="flex flex-wrap content-start w-full min-h-[100px] p-[6px_10px] gap-[8px] bg-transparent shadow-input-inset dark:shadow-[inset_0_0_0_1px_rgb(39,40,43)] rounded-[10px] focus-within:shadow-[inset_0_0_0_1px_rgb(38,109,240),0_0_0_3px_rgba(38,109,240,0.2)] transition-shadow">
                  <input
                    type="text"
                    placeholder="example@email.com"
                    className="flex-1 min-w-[200px] h-[24px] bg-transparent border-none outline-none text-[14px] font-[500] text-[#242529] dark:text-[#EEEFF1] placeholder:text-[#96979A] dark:placeholder:text-[#5C5E63]"
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-[4px]">
                ...
                <button className="flex items-center justify-between w-full h-[34px] px-[10px] bg-transparent shadow-input-inset dark:shadow-[inset_0_0_0_1px_rgb(39,40,43)] rounded-[10px] focus:outline-none focus:shadow-[inset_0_0_0_1px_rgb(38,109,240),0_0_0_3px_rgba(38,109,240,0.2)] transition-shadow">
                  <span className="text-[14px] font-[500] text-[#242529] dark:text-[#EEEFF1] tracking-[-0.14px]">
                    Member
                  </span>
                  <ChevronDown className="w-[14px] h-[14px] text-[#242529] dark:text-[#EEEFF1]" />
                </button>
              </div>
              ...
              <div className="flex flex-col gap-[4px]">
                <div className="flex items-center h-[16px] px-[4px]">
                  <span className="text-[12px] font-[500] text-[rgba(0,0,0,0.55)] dark:text-[rgba(255,255,255,0.55)] tracking-[-0.12px]">
                    Add to team{" "}
                    <span className="text-[rgba(0,0,0,0.4)] dark:text-[rgba(255,255,255,0.29)] ml-1">
                      (optional)
                    </span>
                  </span>
                </div>
                <button className="flex items-center justify-between w-full h-[34px] px-[10px] bg-transparent shadow-input-inset dark:shadow-[inset_0_0_0_1px_rgb(39,40,43)] rounded-[10px] focus:outline-none focus:shadow-[inset_0_0_0_1px_rgb(38,109,240),0_0_0_3px_rgba(38,109,240,0.2)] transition-shadow">
                  <span className="text-[14px] font-[500] text-[rgba(0,0,0,0.4)] dark:text-[#5C5E63] tracking-[-0.14px]">
                    Search or create a team
                  </span>
                  <ChevronDown className="w-[14px] h-[14px] text-[#505154] dark:text-[#A2A4A7]" />
                </button>
              </div>
            </div>

            {/* Footer */}
            <div className="flex items-center justify-end px-[12px] h-[48px] min-h-[48px] bg-[rgba(254,254,254,0.9)] dark:bg-[rgba(25,29,34,0.9)] shadow-[inset_0_1px_0_0_rgba(0,0,0,0.05)] dark:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05)] shrink-0">
