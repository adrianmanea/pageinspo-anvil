...
export default function TrialEndedPage() {
  ...
  return (
    <div className="w-full min-h-screen bg-white dark:bg-[#1b1d21] flex flex-col font-['Inter'] text-[#000000] dark:text-[#EEEFF1] transition-colors duration-200">
        ...
        <div className="w-full max-w-[320px] flex flex-col items-center gap-[40px]">
            ...
            <div className="w-full flex flex-col gap-[8px]">
              ...
              >
                <div className="w-[14px] h-[14px] flex items-center justify-center text-[#266DF0] dark:text-[#4E8CFC]">
                    {/* Grid/Layout Icon */}
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" className="text-[#266DF0] dark:text-[#4E8CFC]">
          ...
          <div className="w-full flex flex-col gap-[8px] items-center">
            ...
            <button className="w-full h-[32px] bg-white hover:bg-gray-50 dark:bg-[#1A1D21] dark:hover:bg-[#2A2B2E] text-[#242529] dark:text-[#EEEFF1] rounded-[9px] flex items-center justify-center gap-[6px] px-[8px] shadow-[inset_0_0_0_1px_rgba(0,0,0,0),0_0_2px_0_rgba(28,40,64,0.18),0_1px_3px_0_rgba(24,41,75,0.04)] dark:shadow-none border border-transparent dark:border-[#27282B] transition-colors duration-200">
               <HelpCircle size={14} className="text-black dark:text-[#EEEFF1]" />
               <span className="text-[14px] font-[500] leading-[20px] tracking-[-0.14px]">
                 Request trial extension
               </span>
            </button>
             ...
             {/* Talk to Sales */}
             <button className="w-full h-[32px] bg-white hover:bg-gray-50 dark:bg-[#1A1D21] dark:hover:bg-[#2A2B2E] text-[#242529] dark:text-[#EEEFF1] rounded-[9px] flex items-center justify-center gap-[6px] px-[8px] shadow-[inset_0_0_0_1px_rgba(0,0,0,0),0_0_2px_0_rgba(28,40,64,0.18),0_1px_3px_0_rgba(24,41,75,0.04)] dark:shadow-none border border-transparent dark:border-[#27282B] transition-colors duration-200">
               <MessageSquare size={14} className="text-black dark:text-[#EEEFF1]" />
               <span className="text-[14px] font-[500] leading-[20px] tracking-[-0.14px]">
                 Talk to sales
               </span>
            </button>
