...
export default function Page() {
  ...
  // Sidebar Groups Data (Exact replica of SettingsAccount)
  const sidebarGroups = [
    {
      title: "Personal",
      items: [
        ...
        { label: "Email and calendar accounts", icon: Briefcase, active: true },
        ...
        <header className="flex h-[49px] min-h-[49px] items-center justify-between border-b border-[#EEEFF1] dark:border-[#27282B] pl-[12px] pr-[12px]">
          <div className="flex items-center gap-[4px]">
            ...
            <div className="flex items-center gap-[6px] rounded-[4px] border border-[#E5E7EB] dark:border-[#27282B] bg-white dark:bg-[#1a1d21] px-[4px] py-[2px] shadow-sm">
              <Briefcase className="h-[14px] w-[14px] text-[#242529] dark:text-[#EEEFF1]" />
          ...
          <div className="flex w-full max-w-[768px] flex-col gap-[40px] pb-[72px] pt-[72px]">
            ...
            <div className="flex flex-col gap-[2px] mb-[40px]">
              ...
              <p className="text-[14px] text-[#505154] dark:text-[rgba(255,255,255,0.55)] leading-[20px] tracking-[-0.14px]">
                Manage and sync your email and calendar accounts to stay
                organized
              </p>
            </div>
            ...
            <section className="flex flex-col gap-[16px]">
              ...
              <div className="p-[8px] border border-dashed border-[#E6E7EA] dark:border-[#2F3033] rounded-[12px] bg-[#FBFBFB] dark:bg-[#15181C] flex items-center gap-[8px]">
              ...
              <div className="flex items-center justify-between p-[10px] px-[16px] bg-white dark:bg-[#1A1D21] rounded-[12px] shadow-[rgb(238,239,241)_0px_0px_0px_1px_inset] dark:shadow-[rgb(39,40,43)_0px_0px_0px_1px_inset]">
                <div className="flex flex-col">
                  ...
                  <span className="text-[12px] font-[500] text-[#505154] dark:text-[rgba(255,255,255,0.55)] leading-[16px] tracking-[-0.12px]">
                    Automatically add “Sent with Attio” to the end of emails
                    sent from Attio.
                  </span>
                </div>
