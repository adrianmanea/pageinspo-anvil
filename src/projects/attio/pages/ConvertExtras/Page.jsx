            ...
            <div className="flex-[8] p-[32px] pr-[24px] border-r border-[#EEEFF1] dark:border-[#27282B] flex flex-col">
              ...
              <div className="mb-[20px]">
                ...
                <div className="flex flex-col gap-[8px]">
                  ...
                  >
                    <div
                      className={`w-[18px] h-[18px] rounded-[10px] border-[6px] ${billingPeriod === "annual" ? "border-[#266DF0] dark:border-[#4E8CFC]" : "border-[#EEEFF1] border-[1px] dark:border-[#27282B] dark:bg-[#1A1D21]"}`}
                    ></div>
                  ...
                  >
                    <div
                      className={`w-[18px] h-[18px] rounded-[10px] border-[6px] ${billingPeriod === "monthly" ? "border-[#266DF0] dark:border-[#4E8CFC]" : "border-[#EEEFF1] border-[1px] dark:border-[#27282B] dark:bg-[#1A1D21]"}`}
                    ></div>
                    <div className="flex-1 flex items-center justify-between">
                      <div className="flex items-center gap-[6px]">
                        <span className="text-[14px] font-[500] text-[#242529] dark:text-[#EEEFF1] leading-[20px] tracking-[-0.14px]">
              ...
              <div>
                ...
                <div className="w-full h-[34px] px-[12px] flex items-center justify-between border border-[#EEEFF1] dark:border-[#27282B] rounded-[10px] cursor-pointer hover:bg-gray-50 dark:hover:bg-[#27282B]">
                  <div className="flex items-center gap-[6px]">
                    <span className="text-[14px] font-[500] text-[#242529] dark:text-[#EEEFF1] leading-[20px] tracking-[-0.14px]">
                      +0
                    </span>
