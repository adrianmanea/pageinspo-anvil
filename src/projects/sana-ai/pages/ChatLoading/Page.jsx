    ...
    <div className="min-h-screen bg-[#FFFFFF] dark:bg-[#131314] flex flex-col w-full relative">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-[868px] w-full mx-auto px-[16px] sm:px-[32px] pt-[16px] pb-[200px]">
          ...
          <button
            disabled
            className="relative min-h-[36px] flex items-center cursor-default"
          >
            {/* Spinner */}
            <div className="absolute left-[-24px] sm:left-[-32px] flex items-center justify-center">
              <div className="w-[20px] h-[20px] border-[2px] border-[#0A1217] dark:border-[#e8e8e8] border-t-transparent dark:border-t-transparent rounded-full animate-spin" />
            </div>
            {/* Shimmer text */}
            <div className="relative">
              <span className="text-[16px] text-[#0A121766] dark:text-[#e8e8e866]">
                Reasoning
              </span>
              <span
                className="absolute inset-0 text-[16px] text-[#0A1217] dark:text-[#e8e8e8]"
                style={{
              ...
              <div className="relative w-full self-center flex flex-col gap-[12px] pointer-events-auto bg-[#FFFFFF] dark:bg-[#131314] rounded-t-[32px]">
                <form>
                  <div className="relative flex">
                    {/* Left button — Plus (disabled) */}
                    <div className="absolute left-[12px] bottom-[10px] z-[1]">
                      <button
                        disabled
                        className="inline-flex h-[36px] w-[36px] items-center justify-center rounded-full bg-transparent font-[400] transition-colors duration-[150ms] focus:outline-none cursor-not-allowed opacity-50"
                        type="button"
                      >
                    ...
                    {/* Right button — Stop generation */}
                    <div className="absolute right-[12px] bottom-[10px] z-[1]">
                      <button
                        aria-label="Stop generation"
                        type="button"
                        className="inline-flex h-[36px] w-[36px] items-center justify-center rounded-full bg-[#0A1217] dark:bg-[#e8e8e8] text-[#FFFFFF] dark:text-[#131314] cursor-pointer transition-colors duration-[150ms]"
                      >
