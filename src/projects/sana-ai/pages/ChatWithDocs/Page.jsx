...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#131314] text-[#0a1217] dark:text-[#e8e8e8] flex flex-col items-center w-full">
      {/* Chat area */}
      <div className="w-full flex flex-col items-center justify-center gap-[16px] pt-[80px] pb-[32px] min-h-[calc(100vh-180px)]">
        ...
        <div className="flex px-[16px] sm:px-[32px] w-full justify-center items-end">
          <div className="flex relative w-full justify-center">
            <div className="relative w-full max-w-[868px] self-center flex-1 flex-col gap-[12px] pointer-events-auto bg-white dark:bg-[#131314] rounded-t-[32px]">
              {/* Form with prompt template */}
              <form className="relative flex-1">
                ...
                <div className="flex-1 border-none outline-none text-[#0a1217] dark:text-[#e8e8e8] text-[16px] leading-[1.5] pr-[56px] py-[16px] rounded-[32px] w-full bg-[#0a12170d] dark:bg-[#e8e8e80d] min-h-[56px] pl-[56px]">
                  Create a financial analysis for{" "}
                  <span className="inline-flex items-center px-[6px] py-[1px] rounded-[4px] bg-[#0285ff18] dark:bg-transparent text-[#0285ff] dark:text-[#e8e8e8] text-[16px] border-b border-dashed border-[#0285ff44] dark:border-[#e8e8e866]">
                    Novo Nordisk
                  </span>{" "}
                  and plot data in graphs
                </div>
                ...
                <div className="absolute right-[12px] bottom-[10px] z-[1]">
                  <button
                    ...
                    type="button"
                    className="inline-flex h-[36px] w-[36px] items-center justify-center rounded-full bg-[#0a1217] dark:bg-[#e8e8e8] text-white dark:text-[#131314] cursor-pointer transition-colors duration-[150ms] hover:bg-[#0a1217e6] dark:hover:bg-[#e8e8e8e6]"
                  >
              ...
              <div className="flex gap-[4px] sm:gap-[8px] items-center mt-[8px]">
                ...
                <DropdownMenu.Root open={openDropdown === 'create'} onOpenChange={(open) => setOpenDropdown(open ? 'create' : null)}>
                  <DropdownMenu.Trigger asChild>
                    <button
                      className="flex flex-row justify-center items-center py-[6px] h-[36px] text-[14px] leading-[20px] whitespace-nowrap text-[#0285ff] transition-all duration-[200ms] gap-[6px] cursor-pointer rounded-full border border-transparent bg-[#0285ff11] px-[16px] pl-[12px] font-[400] data-[state=open]:bg-[#0285ff11]"
                      type="button"
                    >
                      <FileText className="w-[16px] h-[16px] text-[#0285ff]" />
                      <div className="flex items-center gap-[6px]">
                        <span className="truncate">Doc</span>
                        <ChevronDown className="w-[16px] h-[16px] text-[#0285ff] flex-shrink-0 -mr-[4px]" />
                      </div>
                    </button>
                ...
                <DropdownMenu.Root open={openDropdown === 'model'} onOpenChange={(open) => setOpenDropdown(open ? 'model' : null)}>
                  ...
                  <DropdownMenu.Portal>
                    ...
                    >
                      ...
                      <ModelItem
                        name="GPT-5.4"
                        description="High-performance model built for demanding professional tasks"
                      />
                      {/* GPT-5.2 */}
                      <ModelItem
                        name="GPT-5.2"
                      ...
                      <ModelItem
                        name="GPT-5-mini"
                        description="Balanced for intelligence and speed"
                      />
                      {/* Claude Sonnet 4.6 */}
                      <ModelItem
                        name="Claude Sonnet 4.6"
                        description="Excels at coding and complex reasoning"
                      />
                      {/* Claude Opus 4.6 */}
                      <ModelItem
                      ...
                      <ModelItem
                        ...
                        description="Fast responses with near-frontier intelligence"
                      />
        ...
        <div className="w-full flex justify-center px-[16px] sm:px-[32px]">
          <div className="max-w-[868px] w-full mt-[40px]">
            {/* Suggestion 1 — Financial analysis */}
            ...
            {/* Suggestion 2 — Teams meetings */}
            <div className="border-t border-[#0a12170d] dark:border-[#e8e8e80d]">
              <button className="inline-flex gap-[16px] h-[60px] items-center cursor-pointer px-[8px] sm:px-[16px] pointer-events-auto text-[#0a121799] dark:text-[#e8e8e899] hover:text-[#0a1217] dark:hover:text-[#e8e8e8] transition-all max-w-full">
                <AppWindowMac className="w-[16px] h-[16px] flex-shrink-0" />
                <span className="text-[14px] truncate flex-shrink">
                  Summarize my{" "}
                  <strong className="font-[500]">Teams</strong> meetings from
                  yesterday
                </span>
              </button>
            </div>
            ...
            <div className="border-t border-[#0a12170d] dark:border-[#e8e8e80d]">
              <button className="inline-flex gap-[16px] h-[60px] items-center cursor-pointer px-[8px] sm:px-[16px] pointer-events-auto text-[#0a121799] dark:text-[#e8e8e899] hover:text-[#0a1217] dark:hover:text-[#e8e8e8] transition-all max-w-full">
                <Mail className="w-[16px] h-[16px] flex-shrink-0" />
                <span className="text-[14px] truncate flex-shrink">
                  Cut through the noise in{" "}
                  <strong className="font-[500]">Gmail</strong>
                </span>
              </button>
            </div>
            ...
            <div className="border-t border-[#0a12170d] dark:border-[#e8e8e80d]">
              <button className="inline-flex gap-[16px] h-[60px] items-center cursor-pointer px-[8px] sm:px-[16px] pointer-events-auto text-[#0a121799] dark:text-[#e8e8e899] hover:text-[#0a1217] dark:hover:text-[#e8e8e8] transition-all max-w-full">
                <BookOpen className="w-[16px] h-[16px] flex-shrink-0" />
                <span className="text-[14px] truncate flex-shrink">
                  Analyze our{" "}
                  <strong className="font-[500]">Notion</strong>{" "}
                  documentation
                </span>
              </button>
            </div>

            {/* Suggestion 5 — Google Docs */}
            <div className="border-t border-[#0a12170d] dark:border-[#e8e8e80d]">
              <button className="inline-flex gap-[16px] h-[60px] items-center cursor-pointer px-[8px] sm:px-[16px] pointer-events-auto text-[#0a121799] dark:text-[#e8e8e899] hover:text-[#0a1217] dark:hover:text-[#e8e8e8] transition-all max-w-full">
